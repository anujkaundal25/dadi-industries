    ...
    <div className="w-full overflow-x-hidden">
      ...
      <div className="relative overflow-hidden shadow-2xl border-y sm:border border-[#C69D32]/30 bg-[#0B2819] aspect-[4/5] sm:aspect-[16/9] lg:aspect-[21/9] min-h-[480px] sm:min-h-[440px] w-full">
        ...
        {heroSliderBanners.map((slide, idx) => (
          ...
          >
            <div className="absolute inset-0 p-6 sm:p-12 lg:p-16 flex flex-col justify-center max-w-2xl text-[#FAF7F0] space-y-4">
              <div className="flex flex-wrap items-center gap-2">
                <span className="bg-[#C69D32] text-[#0B2819] text-[10px] sm:text-xs font-serif font-bold uppercase tracking-widest px-3 py-1 rounded-full shadow-sm">
                  {slide.badge}
                </span>
                <span className="text-[11px] sm:text-xs font-serif tracking-widest uppercase text-[#E8C86A]">
                  {slide.tag}
                </span>
              </div>

              <h2 className="font-serif text-2xl sm:text-4xl lg:text-5xl font-bold leading-tight tracking-tight text-[#FAF7F0]">
                {slide.heading}
              </h2>

              <p className="text-xs sm:text-base text-[#FAF7F0]/85 leading-relaxed font-sans max-w-xl">
                {slide.subheading}
              </p>
              ...
              <div className="flex flex-col sm:flex-row flex-wrap items-stretch sm:items-center gap-3 pt-2">
                <button
                  ...
                  className="bg-[#C69D32] hover:bg-[#E8C86A] text-[#0B2819] px-6 sm:px-8 py-3.5 rounded-full font-serif font-bold text-xs sm:text-sm shadow-lg transition-all active:scale-95 cursor-pointer flex items-center justify-center gap-2"
                >
                ...
                <button
                  ...
                  className="bg-white/15 hover:bg-white/25 text-[#FAF7F0] backdrop-blur-md border border-white/30 px-5 py-3.5 rounded-full font-serif font-bold text-xs sm:text-sm transition-all active:scale-95 cursor-pointer flex items-center justify-center gap-2"
                >
        ...
        {/* Carousel Navigation Arrows (Hidden on very small screens to avoid clutter, visible on sm+) */}
        <button
          onClick={() => setCurrentSlide((prev) => (prev === 0 ? heroSliderBanners.length - 1 : prev - 1))}
          className="absolute left-3 sm:left-5 top-1/2 -translate-y-1/2 z-20 p-2.5 rounded-full bg-black/40 hover:bg-black/75 text-white backdrop-blur-sm border border-white/20 transition-all cursor-pointer shadow-md"
        ...
        <button
          ...
          className="absolute right-3 sm:right-5 top-1/2 -translate-y-1/2 z-20 p-2.5 rounded-full bg-black/40 hover:bg-black/75 text-white backdrop-blur-sm border border-white/20 transition-all cursor-pointer shadow-md"
          ...
          {heroSliderBanners.map((_, idx) => (
            <button
              ...
              className={`h-2 rounded-full transition-all cursor-pointer ${
                currentSlide === idx ? 'w-8 bg-[#C69D32]' : 'w-2 bg-white/50 hover:bg-white'
              }`}
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 py-6 sm:py-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-lg border border-[#EAE1D0] group bg-[#FAF7F0] flex flex-col justify-between min-h-[340px] sm:min-h-[380px]">
          <img
          ...
          <div className="relative z-10 p-6 sm:p-8">
            <span className="bg-[#103C26] text-[#E8C86A] text-[10px] font-serif font-bold uppercase tracking-widest px-3 py-1 rounded-full border border-[#C69D32]/40">
              The Daily Ritual
            </span>
          </div>

          <div className="relative z-10 p-6 sm:p-8 text-[#FAF7F0] space-y-3">
            <h3 className="font-serif text-2xl sm:text-3xl font-bold leading-tight">
              “Achaar Bina Thali Adhoori”
            </h3>
            <p className="text-xs sm:text-sm text-[#FAF7F0]/80 font-sans max-w-sm">
            ...
            <button
              ...
              className="inline-flex items-center gap-2 text-xs font-serif font-bold text-[#E8C86A] group-hover:text-white transition-colors cursor-pointer pt-1"
            >
        ...
        <div className="relative rounded-3xl overflow-hidden shadow-lg border border-[#EAE1D0] group bg-[#FAF7F0] flex flex-col justify-between min-h-[340px] sm:min-h-[380px]">
          ...
          <div className="relative z-10 p-6 sm:p-8">
            <span className="bg-[#C69D32] text-[#0B2819] text-[10px] font-serif font-bold uppercase tracking-widest px-3 py-1 rounded-full shadow-xs">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-10">
        <div className="bg-gradient-to-r from-[#103C26] via-[#0B2819] to-[#103C26] rounded-3xl p-6 sm:p-8 text-[#FAF7F0] border border-[#C69D32]/40 shadow-xl flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              <Sparkles className="w-4 h-4 text-[#E8C86A]" />
              <span className="text-[11px] uppercase font-serif font-bold tracking-widest text-[#E8C86A]">
            ...
            <p className="text-xs sm:text-sm text-[#FAF7F0]/80 font-sans">
          ...
          <div className="flex items-center shrink-0">
            <button
              ...
              className="w-full md:w-auto bg-[#C69D32] hover:bg-[#E8C86A] text-[#0B2819] px-6 py-3.5 rounded-full font-serif font-bold text-xs sm:text-sm transition-all shadow-md active:scale-95 cursor-pointer flex items-center justify-center gap-2"
            >
